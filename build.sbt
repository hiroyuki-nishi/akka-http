...
val ECRAccount = "<Your AccoutID>"
val BucketName: String = "lspan-spa-akka-http-ops"
...
val RoleARN: String = s"<Your Role Arn>"
...
lazy val root = (project in file("."))
  ...
  settings(
    awscfSettings in Global := AwscfSettings(region = Region,
      ...
      projectName = "lspan-spa-akka-http",
    ...
    awscfStacks := {
      ...
      Stacks(
        Alias("api-service") -> {
          ...
          val repositoryName = "spa/lspan-spa-akka-service"
          val imageVersion = (version in Docker in appHttp).value
          CloudformationStack(
            stackName = "lspan-spa-service",
            template = "api.yaml",
